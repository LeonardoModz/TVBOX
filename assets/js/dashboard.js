	...
	$(function() {
		...
		if ($("#total-profit").length) {
			var totalProfitData = {
				...
				datasets: [{
					label: 'Margin',
					data: [1, 3, 2, 4.5, 5.5, 6.5, 5, 4.2, 5.5,6,8,10],
					backgroundColor: [
						'#cfe1ff',
					],
					borderColor: [
		...
		if ($("#total-expences").length) {
			var totalExpencesData = {
				...
				datasets: [{
					label: 'Margin',
					data: [5, 6.5, 6.5, 5.5, 4.5, 5.5, 6, 7, 5.5,6,7,5],
					backgroundColor: [
						'#e1fff3',
					],
					borderColor: [
		...
		if ($("#device-sales").length) {
			var deviceSalesData = {
				labels: ["Marmara", "Karadeniz", "Ege", "İç Anadolu", "Akdeniz", "Güney Doğu Anadolu", "Doğu Anadolu"],
				datasets: [{
						label: 'Talep',
						data: [450, 500, 300, 350, 200, 320, 310],
						backgroundColor: [
		...
		if ($("#account-retension").length) {
			var accountRetensionData = {
				...
				datasets: [{
						label: 'Talep',
						data: [35, 45, 50, 50,70,90,90,80,95,100,120,135],
						backgroundColor: [
					...
					{
						label: 'Talep',
						data: [40, 40, 60, 70,80,85,85,95,105,110,125,140],
						backgroundColor: [
							'#d8d8d8', '#d8d8d8', '#d8d8d8', '#d8d8d8', '#d8d8d8','#d8d8d8','#d8d8d8', '#d8d8d8', '#d8d8d8', '#d8d8d8', '#d8d8d8','#d8d8d8',
						],
						borderColor: [
					...
					{
						label: 'Talep',
						data: [30, 35, 45, 60,60,70,95,90,100,105,120,145],
						backgroundColor: [
							'#d8d8d8', '#d8d8d8', '#d8d8d8', '#d8d8d8', '#d8d8d8','#d8d8d8','#d8d8d8', '#d8d8d8', '#d8d8d8', '#d8d8d8', '#d8d8d8','#d8d8d8',
						],
						borderColor: [
		...
		if ($("#my-balance-dark").length) {
			var myBalanceDarkData = {
				...
				datasets: [{
						label: 'Demand',
						data: [90, 85, 100, 105,120,130,145,160,150,140,155,165],
						backgroundColor: [
							'#0062ff', '#0062ff', '#0062ff', '#0062ff',
						],
						borderColor: [
